...
```
composer require wovoschool/laravel-language
```
...
```php
WovoSchool\Language\Provider::class,
```

Add alias if you want to use the facade.

```php
'Language'   => WovoSchool\Language\Facade::class,
```
...
If you discover any security related issues, please email security@wovoschool.com instead of using the issue tracker.
